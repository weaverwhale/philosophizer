...
echo ""
echo "📋 Vector data was indexed using:"
echo "   - Embedding Model: text-embedding-nomic-embed-text-v1.5-embedding"
echo "   - LLM Model (HQE): qwen/qwen3-1.7b"
echo ""
echo "⚠️  Important: Use the same embedding model when querying for best results"
echo ""
...
echo "   4. Set EMBEDDING_MODEL=text-embedding-nomic-embed-text-v1.5-embedding"
echo ""
echo "🎯 To use locally:"
